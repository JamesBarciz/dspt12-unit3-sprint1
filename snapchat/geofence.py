...
# WTF is a Geofence?
# Set of vertices or lines that surround a geographical area

# Objects and Actions
# Classes (nouns): Geofence, Edge, Vertex


class Edge:
    # self == "reflection" The instantiated object will be aware of itself
